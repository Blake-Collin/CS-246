...
/**
 * The NSALoginController class handles password hashing and verification for the {@link User}
 * class.
 *
 * <p>It contains only static methods, and therefore maintains no state. Another example of a class
 * containing only static methods is Java's built-in {@link java.lang.Math} class.
 *
 * <p>Notice the interesting formatting used in this comment block. This special formatting is
 * called Javadocs and is used by Java IDEs to automatically generate documentation for classes.
 *
 * <p>Many Java IDEs will help you automatically generate the formatting for the Javadoc comments.
 *
 * <p>Javadocs are widely used in industry, and if you work for a company that uses Java code, you
 * will almost certainly be expected to include Javadocs in your own code, so it's a good habit to
 * develop.
 *
 * <p>You can use the <code>javadoc</code> tool to generate fancy HTML files. For example:
 *
 * <p><code>javadoc *.java -d ./doc</code>
 *
 * <p>Then you can open the index.html file in the doc directory.
 *
 * <p>For more information about <em>how</em> to write javadocs see:
 *
 * <p><a href="https://www.tutorialspoint.com/java/java_documentation.htm">Javadoc Tutorial</a>
 *
 * <p>For more information about <em>when</em> to write javadocs see these Stack Overflow posts:
 *
 * <ul>
 *   <li><a
 *       href="http://stackoverflow.com/questions/211041/do-you-use-javadoc-for-every-method-you-write">Do
 *       you use Javadoc for every method you write?</a>
 *   <li><a
 *       href="http://stackoverflow.com/questions/398546/technical-tips-for-writing-great-javadoc">Technical
 *       tips for writing great Javadoc</a>
 *   <li><a href="http://stackoverflow.com/questions/1028967/simple-getter-setter-comments">Simple
 *       Getter/Setter comments</a>
 *   <li><a
 *       href="http://stackoverflow.com/questions/3607641/javadoc-comments-vs-block-comments">Javadoc
 *       comments vs block comments?</a>
 *   <li><a
 *       href="http://stackoverflow.com/questions/21632086/javadoc-for-private-protected-methods">Javadoc
 *       for private/protected methods?</a>
 * </ul>
 *
 * @author Brother Falin
 * @version 1.0
 * @since 2016-12-08
 *     <p>This code was adapted from <a href="http://stackoverflow.com/a/18143616/28106">this Stack
 *     Overflow post</a>.
 */
public final class NSALoginController {
  ...
  /**
   * This function takes the password from the {@link User} class and hashes it. As a side-effect,
   * the original password value is removed for security purposes.
   *
  ...
  /**
   * This function uses the password and salt in the {@link User} to generate a hash, then compares
   * that hash to the original hash value.
   *
   * @param user The user whose password needs to be hashed.
  ...
  public static Boolean verifyPassword(User user) throws Exception {
    ...
    if (expectedHash == null || expectedHash.length != userHash.length) return false;
    ...
    for (int i = 0; i < expectedHash.length; i++) {
      if (expectedHash[i] != userHash[i]) return false;
    }
